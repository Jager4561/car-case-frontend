...
import { PostsFilterRules } from '@/composables/store/filters/filters.model';
    ...
    <Transition name="drawer-left">
      <div v-show="mobileView === 'filters' || isDesktop" class="page_container__filters">
        <div ref="filtersRef" class="page_container__filters__wrapper drawer__wrapper">
          <HomeFilters :filters="filters" :resultCount="postsMeta?.total" :invokeClearFilters="clearFiltersSubject" @onFiltersUpdate="onFiltersChange" />
        </div>
      </div>
    </Transition>
